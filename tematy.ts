...
class Link {
    ...
    constructor(link: string, description: string, big_description?: string) {
        this.link = link
...
class Lesson {
    ...
    setExpDate(month: number, year: number) {
    ...
    get_HTML_row(fields: Array<string>) {
        let row = document.createElement("tr");
...
function add_lessons() {
    let lesson_section_int = document.getElementById("lessons_introductory");
    let lesson_section_ext = document.getElementById("lessons_extension");

    let table_int = document.createElement("table");
    let table_ext = document.createElement("table");
...
class Book {
    ...
    constructor(name?: string, author?: string, comment?: string, link?: string) {
        this.name = name;
        this.author = author;
...
function iter_add_elements(parent_id: string, array) {
    let section = document.getElementById(parent_id);
